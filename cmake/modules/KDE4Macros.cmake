...
# the files listed here will be removed by remove_obsoleted_cmake_files.cmake, Alex
   ...
   foreach ( _current_FILE ${ARGN})
      ...
      file(APPEND ${CMAKE_CURRENT_BINARY_DIR}/remove_files.cmake "execute_process(COMMAND ${CMAKE_COMMAND} -E remove ${module_install_dir}/${_current_FILE} OUTPUT_VARIABLE _dummy)\n" )
   endforeach ( _current_FILE)
...
#            message("png2ico ${_outfilename}.ico ${ARGN}")
            execute_process(COMMAND png2ico ${_outfilename}.ico ${ARGN})
