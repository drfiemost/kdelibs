...
if(GSSAPI_LIBS AND GSSAPI_FLAVOR)
  ...
  if(KRB5_CONFIG)
    ...
    execute_process(COMMAND ${KRB5_CONFIG} --libs gssapi RESULT_VARIABLE _return_VALUE OUTPUT_VARIABLE GSSAPI_LIBS OUTPUT_STRIP_TRAILING_WHITESPACE)
    if(_return_VALUE)
      message(STATUS "GSSAPI configure check failed.")
      set(HAVE_KRB5_GSSAPI FALSE)
    endif(_return_VALUE)
  
    execute_process(COMMAND ${KRB5_CONFIG} --cflags gssapi RESULT_VARIABLE _return_VALUE OUTPUT_VARIABLE GSSAPI_INCS OUTPUT_STRIP_TRAILING_WHITESPACE)
    string(REGEX REPLACE "(\r?\n)+$" "" GSSAPI_INCS "${GSSAPI_INCS}")
    string(REGEX REPLACE " *-I" ";" GSSAPI_INCS "${GSSAPI_INCS}")

    execute_process(COMMAND ${KRB5_CONFIG} --vendor RESULT_VARIABLE _return_VALUE OUTPUT_VARIABLE gssapi_flavor_tmp OUTPUT_STRIP_TRAILING_WHITESPACE)
