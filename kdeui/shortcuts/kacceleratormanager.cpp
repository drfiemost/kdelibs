...
public:
    ...
    static bool checkChange(const KAccelString &as)  {
        ...
        {
            if (as.accel() == -1)  {
                removed_string  += "<tr><td>" + t1.toHtmlEscaped() + "</td></tr>";
            } else if (as.originalAccel() == -1) {
                added_string += "<tr><td>" + t2.toHtmlEscaped() + "</td></tr>";
            } else {
                changed_string += "<tr><td>" + t1.toHtmlEscaped() + "</td>";
                changed_string += "<td>" + t2.toHtmlEscaped() + "</td></tr>";
            }
            return true;
        }
        return false;
