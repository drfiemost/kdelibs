...
void KCalendarTest::testStrings(KLocale::DigitSet testDigitSet)
{
    ...
    //Test Year String
    QCOMPARE(calendar->formatDate(testDate, KLocale::Year),
             locale->convertDigits("2005", locale->dateTimeDigitSet()));
    QCOMPARE(calendar->formatDate(testDate, KLocale::Year, KLocale::LongNumber),
             locale->convertDigits("2005", locale->dateTimeDigitSet()));
    QCOMPARE(calendar->formatDate(testDate, KLocale::Year, KLocale::ShortNumber),
             locale->convertDigits("05", locale->dateTimeDigitSet()));

    //Test Month String
    QCOMPARE(calendar->formatDate(testDate, KLocale::Month),
             locale->convertDigits("01", locale->dateTimeDigitSet()));
    QCOMPARE(calendar->formatDate(testDate, KLocale::Month, KLocale::LongNumber),
             locale->convertDigits("01", locale->dateTimeDigitSet()));
    QCOMPARE(calendar->formatDate(testDate, KLocale::Month, KLocale::ShortNumber),
             locale->convertDigits("1", locale->dateTimeDigitSet()));

    //Test Day String
    QCOMPARE(calendar->formatDate(testDate, KLocale::Day),
             locale->convertDigits("03", locale->dateTimeDigitSet()));
    QCOMPARE(calendar->formatDate(testDate, KLocale::Day, KLocale::LongNumber),
             locale->convertDigits("03", locale->dateTimeDigitSet()));
    QCOMPARE(calendar->formatDate(testDate, KLocale::Day, KLocale::ShortNumber),
             locale->convertDigits("3", locale->dateTimeDigitSet()));
